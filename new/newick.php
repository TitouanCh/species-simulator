<html lang="en">
        <head>
            <title>Newick tree parser and renderer online</title>
            <meta name="viewport" content="width=device-width, initial-scale=1">
            <meta name="Description" content="A renderer and a parser of the Newick tree format in the browser.">
...
Newick Tree : </br>
<textarea id="treeString" cols="100" rows="5" style="font-weight: bold; max-width: 98%;">(A:0.1,B:0.2,((E:0.1, F:0.1)C:0.3,((Z:0.02, U:0.04, I:0.2, H:0.21)X:0.2, P:0.112)D:0.05)E:0.1)F;</textarea>
