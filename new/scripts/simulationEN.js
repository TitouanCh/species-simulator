...
var workerPath = "/scripts/species-simulator/setupworker.js";
...
function afficheEspece() {
	...
	especesData.forEach(function(espece) {
		...
		document.getElementById("gestionEspeces").innerHTML += 'Specie ' + idx + ':';
		
		document.getElementById("gestionEspeces").innerHTML += '</br> --- Color : ' + '<input type="color" value="' + espece[2] + '" id="couleurEspece' + idx + '">';
		...
		document.getElementById("gestionEspeces").innerHTML += '</br> --- Probability of Reproduction: ' + '<input type="number" min="1" max="100" value="' + espece[0] + '" id="tauxReproductionEspece' + idx + '">%';
		document.getElementById("gestionEspeces").innerHTML += '<label class ="hiddenLabel" for="tauxReproductionEspece' + idx + '">Choose a reproduction percentage for the specie ' + idx + '.</label>';
		
		document.getElementById("gestionEspeces").innerHTML += '</br> --- Probability of Predation: ' + '<input type="number" min="1" max="100" value="' + espece[3] + '" id="tauxPredationEspece' + idx + '">%';
		document.getElementById("gestionEspeces").innerHTML += '<label class ="hiddenLabel" for="tauxPredationEspece' + idx + '">Choose a predation percentage for the specie ' + idx + '.</label>';
		
		document.getElementById("gestionEspeces").innerHTML += '</br> --- Preys on : '
		
		var idx2 = 1
		especesData.forEach(function(espece) {
			document.getElementById("gestionEspeces").innerHTML += '<label for="regimeEspece' + idx + 'for' + idx2 + '" style ="visibility: visible; display: inline;">Specie ' + idx2 + ' </label><input id="regimeEspece' + idx + 'for' + idx2 + '" type="checkbox"/>'
		...
		document.getElementById("gestionEspeces").innerHTML += '</br> --- Life expectancy : ' + '<input type="number" min="1" max="500" value="' + espece[1] + '" id="ageMaxEspece' + idx + '">';
		document.getElementById("gestionEspeces").innerHTML += '<label class ="hiddenLabel" for="ageMaxEspece' + idx + '">Maximum age for specie ' + idx + '.</label>';
		document.getElementById("gestionEspeces").innerHTML += '</br>'
