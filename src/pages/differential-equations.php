<div class="article">
    ...
    <p>
        Despite its simplicity, this equation has some cool applications.
        In population dynamics, we can use it to model the growth of a population.
        We can define:</br>
    <ul>
        <li>y': correponding to the speed at which the population is growing.</li>
        <li>y : corresponding to the population size.</br></li>
        <li>α : corresponding to the population's growth factor.</br></li>

    </ul>
    <p>
        With our equation : y'(t) = αy(t), our growth speed (y') will be proportional to our population size (y) and
        our growth factor (α).
    </p>
    <p>
        Differential equations are fun tools to study phenomenons where the rate of change is affected by its
        parameters.
    </p>

    <script src="/assets/js/differential/differential1.js"></script>
