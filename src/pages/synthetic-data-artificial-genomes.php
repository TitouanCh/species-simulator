<div class="article">
    ...
    <p class="short-intro">
        ...
        In the winter of 2023, I had the pleasure of working with a team on artificial genomes generated by neural
        networks. This is an interesting area very close the synthetic life. This is a very brief overview of the work
        I've achieved while with this team.
    </p>
    ...
    <p>
        A promising solution to this scarcity of data is the use of synthetic data. This approach offers a way to
        generate new datasets that retain the key characteristics of real data. It also offers a potential way to
        address privacy concerns, serving as an intermediary by generating data that reflects real patterns without
        revealing the original, sensitive information, provided, there's no way to reconstruct the original data from
        the synthetic data.
    </p>
    ...
    <p>
        Synthetic data refers to artificially generated data that mimics real-world data. It is produced by generating
        new data points based on the patterns and statistical properties of an original dataset. The goal is to maintain
        the essential features of the original data while expanding the dataset to improve the performance of machine
        learning models.
    </p>
    <p>
        However, there's some risks to using synthetic data. These risk are mostly related to how you generate the
        synthetic data but it can lead to overfitting: where models perform well on training data but fail to generalize
        to real-world scenarios.
    </p>

    <h2>Generating synthetic genomes</h2>

    <p>In the project, synthetic genomes were generated using a Wasserstein Generative Adversarial Network (WGAN). WGANs
        are a specific type of deep learning model designed to generate realistic synthetic data by optimizing a
    ...
    <p>The technical aspects of the WGAN were not the center of my work, so I won't expend too much on it. My focus was
        on analyzing the synthetic genomic data that was produced. As I've talked about before, the quality of this
        synthetic data was crucial in determining whether it retained the fundamental properties of the original human
        genome data and if it was useful or not.</p>

    <h2>Labeling synthetic data</h2>

    <p>One main topic in population genetics is studying genetic variations among populations. A common task is to
    ...
    <p>To assess the quality and utility of the synthetic genomic data, we conducted experiments by training a
        convolutional neural network (CNN) called LAI-NET on both real and synthetic data. LAI-NET is designed for tasks
        related to local ancestry inference (LAI), which involves identifying the ancestral origins of different
        segments of an individual's genome.</p>
    ...
    <p>Our results were encouraging. LAI-NET achieved comparable performance regardless of whether it was trained on
        ...
        essential features of the real genomic data, making it a valuable tool for future research in genomics and AI.
    </p>


    <h2>Conclusion</h2>

    <p>The use of synthetic data in genomics opens up new possibilities for advancing research and training machine
        learning models, especially in areas where data is scarce or limited due to privacy concerns. By generating
        high-quality synthetic genomes, we can enhance AI models' ability to learn from genetic data without
        compromising on accuracy. However, as with any tool, synthetic data must be used responsibly to avoid
        overfitting and ensure that models trained on synthetic data can generalize well to real-world applications.
    </p>
