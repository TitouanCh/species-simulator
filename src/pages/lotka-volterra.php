<div class="article">
    ...
    <p class="short-intro">
        ...
        Lotka Volterra equations are a system of differential equations used to model interactions between different
        species...
    </p>
    ...
    <div id='Species Simulator parameters' class='simulation_parameters'
        ...
        <input type="number" id="alpha-equation" name="alpha-equation" style="width:30px; text-align:center;"
            value="2.5">,

        <label for="beta-equation">Beta : </label>
        <input type="number" id="beta-equation" name="beta-equation" style="width:30px; text-align:center;"
            value="-0.2">,

        <label for="delta-equation">Delta : </label>
        <input type="number" id="delta-equation" name="delta-equation" style="width:30px; text-align:center;"
            value="0.4">,

        <label for="gamma-equation">Gamma : </label>
        <input type="number" id="gamma-equation" name="gamma-equation" style="width:30px; text-align:center;"
            value="-3">,
    ...
    <p>
        In the 1920's Alfred <b>Lotka</b> and Vito <b>Volterra</b> independently proposed the first mathematical model
        describing a predator-prey relationship.</br>
        </br>
        This discovery would give birth new discipline: mathematical ecology or theorical ecology, the science of using
        mathematical, computational and conceptual models to study ecological systems like population dynamics or
        ecosystem interrelationships.</br>
        </br>


        Above, you can see the predator-prey Lotka-Volterra model represented in a vector field. You can easily observe
        the cyclic nature of the model. It’s made by scattering random points on a graph, with the x coordinates and y
        coordinates representing the prey and predator population respectively. Then we can use our differential
        equations described below to draw a vector toward the next estimated position of our data point.</br></br>

        It's quite enjoyable to look at, have a go at changing the various parameters and see if you can make some
    ...
    <p>
        ...
        field.</br> <br>
        Frequently used to describe a system in which a predator and a prey interact. It can only simulate interactions
        ...
        The equation shown above is to compute the population of species i. Of course, it needs to be repeated as many
        times as there are species in our model.
        <!--To learn more, click here.</br>-->
    </p>
