...
var canvas = document.getElementById("Game of Life simulation");
var s;
...
function main(){
	...
	// Set initial display width and height: crude
	document.getElementById('displayWidth').value = canvas.parentElement.offsetWidth - canvas.parentElement.offsetWidth * 0.0;
