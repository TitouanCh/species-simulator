<header class="phone-menu" style="position: sticky; top: 0; width: 100%">
    <ul style="background: linear-gradient(0.25turn, #333 35%, #000); list-style: none; height: 50px; margin-bottom: 0">
        <li><a href="/en/index.php" style="font-weight: bold; top: 11; position: relative; color: white;">Species-Simulator.com</a></li>
        <li>
            <div class="phone-button" width="16" style="position: absolute; top: 16px; right: 16px;" onclick="toggle_phone_menu()">
