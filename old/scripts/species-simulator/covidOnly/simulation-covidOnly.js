...
function getRatiosRight() {
	...
	var modifierLong = longueurTableau/longueurCase
	var modifierHaut = hauteurTableau/hauteurCase
	
	while (longueurTableau > screen.width - 175) {
		longueurTableau = longueurTableau - modifierLong;
		hauteurTableau = hauteurTableau - modifierHaut;
		
		longueurCase = longueurTableau/modifierLong;
		hauteurCase = hauteurTableau/modifierHaut;
