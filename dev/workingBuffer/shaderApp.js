...
function main(){
	...
	const coordData = new Float32Array(getAllCoord(gl, 3.0));
	...
	const targetTextureWidth = 1260;
	const targetTextureHeight = 840;
	...
	function gol(PROGRAM, string) {
		...
		if (string == "copy") {
			...
			gl.uniform1f(sizeLocation_Copy, 3.0);
			gl.uniform1i(textureLocation_Copy, 0);
		} else {
			gl.uniform2f(resolutionLocation, gl.canvas.width, gl.canvas.height);
			gl.uniform1f(sizeLocation, 3.0);
