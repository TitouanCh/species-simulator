...
<label for="brush">Choose a brush/pattern to use for the mouse:</label>
...
You may have to restart the simulation for some of these changes to take effect.
</br>
...
<label for="borderSize">Display Width:</label>
<input type="number" id="displayWidth" name="displayWidth" value="1260" min="10" max="10000">

<label for="borderSize">Display Height:</label>
<input type="number" id="displayHeight" name="displayHeight" value="840" min="10" max="10000">

<label for="seed">Seed (Works best with long non repeating numbers between 0 and 1):</label>
